...
WebUI.scrollToElement(findTestObject('Alert Pop Up/alert box'), 2)

WebUI.click(findTestObject('Alert Pop Up/alert box'))

WebUI.acceptAlert()

WebUI.delay(2)

WebUI.scrollToElement(findTestObject('Alert Pop Up/Conf box'), 2)

WebUI.click(findTestObject('Alert Pop Up/Conf box'))
