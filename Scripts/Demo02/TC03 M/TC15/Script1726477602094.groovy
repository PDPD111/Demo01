...
WebUI.setText(findTestObject('LOGIN/user name'), user1)

WebUI.setText(findTestObject('LOGIN/Pass'), pass1)
...
WebUI.setText(findTestObject('LOGIN/date'), date1)

WebUI.setText(findTestObject('LOGIN/comment'), Comm1)
